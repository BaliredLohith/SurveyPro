  ...
  useEffect(() => {
    if (user) {
      setFormData({
        ...
        bio: user.bio || 'Experienced project manager overseeing survey operations and team coordination.'
      });
    }
  }, [user]);
            ...
            >
              ...
              <div className="flex items-center mb-6">
                <div className="relative">
                  <div className="w-24 h-24 bg-blue-500 rounded-full flex items-center justify-center text-white text-2xl font-medium">
