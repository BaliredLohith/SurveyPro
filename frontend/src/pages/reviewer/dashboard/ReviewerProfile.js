  ...
  useEffect(() => {
    if (user) {
      setFormData({
        ...
        bio: user.bio || 'Detail-oriented reviewer ensuring survey quality and compliance with standards.'
      });
    }
  }, [user]);
            ...
            >
              ...
              <div className="flex items-center mb-6">
                <div className="relative">
                  <div className="w-24 h-24 bg-purple-500 rounded-full flex items-center justify-center text-white text-2xl font-medium">
