...
const ReviewerSettings = () => {
  ...
  useEffect(() => {
    ...
    const savedSettings = localStorage.getItem('reviewerSettings');
    if (savedSettings) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      localStorage.setItem('reviewerSettings', JSON.stringify(settings));
      // Simulate API call
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Receive email notifications for review updates</p>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-medium text-gray-900">Review Updates</p>
                    <p className="text-sm text-gray-600">Get notified about new surveys to review</p>
                  </div>
                  <button
                    onClick={() => handleToggle('notifications', 'reviewUpdates')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      settings.notifications.reviewUpdates ? 'bg-blue-600' : 'bg-gray-200'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                        settings.notifications.reviewUpdates ? 'translate-x-6' : 'translate-x-1'
                      }`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Get notified when your reviews are approved</p>
                  </div>
                  <button
                    onClick={() => handleToggle('notifications', 'approvalNotifications')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      settings.notifications.approvalNotifications ? 'bg-blue-600' : 'bg-gray-200'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                        settings.notifications.approvalNotifications ? 'translate-x-6' : 'translate-x-1'
                      }`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Get reminded about review deadlines</p>
                  </div>
                  <button
