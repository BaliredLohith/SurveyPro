...
const ViewerSettings = () => {
  ...
  useEffect(() => {
    ...
    const savedSettings = localStorage.getItem('viewerSettings');
    if (savedSettings) {
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Receive email notifications for new reports</p>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => handleToggle('notifications', 'reportUpdates')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      settings.notifications.reportUpdates ? 'bg-blue-600' : 'bg-gray-200'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                        settings.notifications.reportUpdates ? 'translate-x-6' : 'translate-x-1'
                      }`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-medium text-gray-900">New Surveys</p>
                    <p className="text-sm text-gray-600">Get notified about new survey submissions</p>
                  </div>
                  <button
                    onClick={() => handleToggle('notifications', 'newSurveys')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      settings.notifications.newSurveys ? 'bg-blue-600' : 'bg-gray-200'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                        settings.notifications.newSurveys ? 'translate-x-6' : 'translate-x-1'
                      }`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Get reminded about survey deadlines</p>
                  </div>
                  <button
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => handleToggle('preferences', 'autoRefresh')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
